...
def idteman():
	if log != 1:
		cetak('!h[*] Login !bFB Elu !hdulu Gan...')
		login()
		if log == 0:
			keluar()
...
def menu():
 ...
 !m* !cM.Gibran Alghazie
 !m* !phttps://github.com/boykecik05/crackfb
 !m* !phttps:/www.facebook.com/boykecik40
 !m* !pNo Whatsapp: +12494934733
!k.======================.
|!h  AMBIL !mID!h DARI.....  !k|
'======================'
!k#!p1 !hDAFTAR TEMAN KLEAN
!k#!p2 !hANGGOTA GROUP YANG SUDAH BERGABUNG
!k#!p3 !bFILE DARI WORDLIST
!k#!p4 !mKELUAR...''')
